/*
 *  Adapted from the structs given by Codemasters Member `Hoo` at Codemasters forum[1]. June 2017
 *  [1]: http://forums.codemasters.com/discussion/53139/f1-2017-d-box-and-udp-output-specification
*/
...
struct ParticipantData {
  ...
  char m_name[48];        // Name of participant in UTF-8 format ï¿½ null terminated, Will be truncated with ï¿½ (U+2026) if too long
};
...
struct PacketCarTelemetryData {
  ...
  uint32_t m_buttonStatus;    // Bit flags specifying which buttons are being pressed currently - see appendices
};
...
struct CarStatusData {
  ...
  uint8_t m_tyreCompound;           // Modern - 0 = hyper soft, 1 = ultra soft, 2 = super soft, 3 = soft, 4 = medium, 5 = hard, 6 = super hard, 7 = inter, 8 = wet, Classic - 0-6 = dry, 7-8 = wet
  ...
  uint8_t m_ersDeployMode;          // ERS deployment mode, 0 = none, 1 = low, 2 = medium, 3 = high, 4 = overtake, 5 = hotlap
